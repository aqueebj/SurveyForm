...
function QuestionsTab(props) {
    ...
    function questionsUI() {
        return questions.map((ques, i) => (
                                    ...
                                    <Accordion onChange={() => {
                                            ...
                                            {!questions[i].open ? (
                                                <div style={{
                                                    ...
                                                    <Typography variant="subtitle1"
                                                                style={{marginLeft: '0px'}}>{i + 1}. {ques.questionText}</Typography>


                                                    {ques.questionImage !== "" ? (
                                                        <div>
                                                            <img src={ques.questionImage} width="400px"
                                                                 height="auto"/><br></br><br></br>
                                                        </div>
                                                    ) : ""}
                                        ...
                                        <AccordionDetails>
                                            <div style={{
                                                        ...
                                                        checkImageHereOrNotForQuestion(ques.questionImage) ? (
                                                            <div>
                                                                <div style={{
                                                                    ...
                                                                    <img src={ques.questionImage} width="150px"
                                                                         height="auto"/>
                                                                    <IconButton style={{
                                                                        marginLeft: '-15px',
                                                                        marginTop: '-15px',
                                                ...
                                                {/* // checking for different types of questions */}
                                                {text === true ?
                                                    (
                                                        <div>
                                                            <div style={{width: '100%'}}>
                                                            ...
                                                            {/* {(ques.options.length < 4  && text === false)? (
                  <div>
                ...
                <Typography variant="body2" style={{color: 'grey'}}>You can add maximum 4 options.You can duplicate the questions and remove it.</Typography> */}
                                                        </div>
                                                    ) : <div>
                                                        <div style={{width: '100%'}}>
                                                            {ques.options.map((op, j) => (
                                                        ...
                                                        {(ques.options.length < 4 && text === false) ? (
                                                            <div>
                                                                <FormControlLabel disabled control={<AddCircleIcon/>}
                                                                                  label={
                                                        ...
                                                        <Typography variant="body2" style={{color: 'grey'}}>You can add
                                                            maximum 4 options.You can duplicate the questions and remove
                                                            it.</Typography>
        ...
        <div style={{marginTop: '15px', marginBottom: '7px', paddingBottom: "30px"}}>
            ...
            >
                ...
                <Grid item xs={12} sm={5} style={{width: '100%'}}>
                    ...
                    <Grid style={{borderTop: '10px solid darkblue', borderRadius: 10}}>
                        <div>
                            <div>
                    ...
                    <Grid style={{paddingTop: '10px'}}>
                        <div>
                            <ImageUplaodModel handleImagePopOpen={openUploadImagePop} handleImagePopClose={() => {
                          ...
                          style={{margin: '5px'}}
                        >Add Question </Button> */}
                                <Button variant="contained" endIcon={<AddCircleIcon/>} style={{margin: '5px'}}
                                ...
                                >
                                    <MenuItem onClick={addMoreQuestionField}>MCQ</MenuItem>
                                    <MenuItem onClick={addTextQuestionField}>Text</MenuItem>
